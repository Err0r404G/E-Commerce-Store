...
$vendorRole = 'VENDOR';
$vendorAvatar = $profile['profile_pic'] ?? null;
$activeVendorPage = 'profile';
...
<section class="admin-layout vendor-layout">
    ...
    <main class="admin-content vendor-content">
        <section class="vendor-profile-page">
            ...
            <?php if ($errors): ?>
                <div class="auth-message auth-message-error vendor-profile-message">
            ...
            <?php if ($success): ?>
                <div class="auth-message auth-message-success vendor-profile-message">
            ...
            <form class="vendor-profile-form" action="/E-Commerce-Store/index.php?page=vendorProfile" method="POST" enctype="multipart/form-data">
                ...
                <div class="vendor-profile-actions">
                    <a href="/E-Commerce-Store/index.php?page=vendorDashboard">Cancel</a>
                    <button type="submit">
