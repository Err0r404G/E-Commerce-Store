<section class="vendor-coupons-page">
    <div class="page-header">
        <h1>Promo Codes</h1>
        <p>Create and manage promotional coupon codes for your shop.</p>
    </div>
    ...
    <div class="vendor-inventory-grid">
        <form class="vendor-product-form vendor-profile-panel" id="vendorCouponForm">
            ...
            <div class="vendor-profile-grid">
                <label>
                    Code
                    <input type="text" name="code" id="vendorCouponCode" placeholder="SAVE20" required>
                </label>

                <label>
                    Discount Percentage
                    <input type="number" name="discount_pct" id="vendorCouponDiscount" min="1" max="100" step="0.01" required>
                </label>

                <label>
                    Maximum Uses
                    <input type="number" name="max_uses" id="vendorCouponMaxUses" min="1" step="1" required>
                </label>
            ...
            <div class="vendor-profile-actions vendor-product-actions">
                <button type="button" class="vendor-secondary-btn" id="vendorCouponReset">Clear</button>
                <button type="submit">
                ...
                <table class="category-table vendor-product-table">
                    ...
                    <tbody>
                        <?php if (empty($coupons)): ?>
                            <tr>
                                <td colspan="6" class="empty-cell">No coupons found. Create your first promo code above.</td>
                            </tr>
                        <?php endif; ?>
                        ...
                        <?php foreach ($coupons as $coupon): ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button type="button" class="edit-category vendor-toggle-coupon" data-coupon-toggle data-coupon-id="<?= (int) $coupon['id'] ?>">
